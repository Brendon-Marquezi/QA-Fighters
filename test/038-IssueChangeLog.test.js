...
test('Check an issue\'s change log', async () => {
    ...
    try {
        ...
        console.error('Erro ao obter log de alterações:', error.response ? error.response.data : error.message);
    }
});
...
afterEach(async () => {
    ...
    try {
        ...
        console.error('Erro ao excluir issue:', error.response ? error.response.data : error.message);
    }
});
